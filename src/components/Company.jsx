                    ...
                    <Table sx={{ minWidth: 650 }} aria-label="simple table">
                        <TableHead>
                            <TableRow className='Table_head'>
                                ...
                                <TableCell className='Cell_item' align="center">NIT</TableCell>
                                <TableCell className='Cell_item' align="center">Dirección</TableCell>
                                <TableCell className='Cell_item' align="center">Telefono</TableCell>
                                <TableCell className='Cell_item' align="center">Fecha creación</TableCell>
                                {
                                    role === "admin" &&
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogContent className='Dialog_container'>
                    <Box
                        component="form"
                        noValidate
                        sx={{ '& .MuiTextField-root': { m: { xs: 1, sm: 3 }, width: { xs: '100%', sm: '41%' } }, }}
                        autoComplete="off">
                        <TextField
                            id="outlined-error"
                            label="Nombre"
                ...
                <DialogActions className='Div_button_container'>
                    ...
                    <Button className='Button Add' disabled={formValidation.fullName || formValidation.nit || formValidation.address || formValidation.phone} onClick={handleCreate}>Guardar</Button>
                </DialogActions>
            </Dialog>

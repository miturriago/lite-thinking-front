      ...
      <div className='Div_drawer_footer'>
        {
          role === "admin" ?
            ...
            <Chip className='Chip_user' variant="outlined"
              avatar={<Avatar>A</Avatar>} label="Admin" />
            :

            <Chip className='Chip_user' variant="outlined"
              avatar={<Avatar>U</Avatar>} label="Externo" />
        }
        <Divider className='Divider' />
        <Button onClick={() => { handleLogout() }} color='secondary' variant="text">Cerrar sesión</Button>
